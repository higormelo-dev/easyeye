...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function aiWorkflowLabel(workflow) {
      ...
      if (workflow === "consensus_review") return aiLabel("workflow_consensus_review", "Revisão por consenso");
      return workflow;
    }
    function aiPayload() {
      return {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(AppLayout, mergeProps({
        ...
        "top-actions": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (aiEnabled.value) {
              _push2(`<div class="header-item d-none d-sm-flex me-2" data-v-db3478e0${_scopeId}><button class="btn btn-liner-gradient d-inline-flex align-items-center gap-1" type="button"${ssrRenderAttr("title", aiLabel("assistance_button", "Assistente de IA"))} data-v-db3478e0${_scopeId}><i class="ti ti-robot fs-16" data-v-db3478e0${_scopeId}></i><span class="fw-medium" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiLabel("assistance_button", "Assistente de IA"))}</span><i class="ti ti-chevron-down fs-12 opacity-75" data-v-db3478e0${_scopeId}></i></button></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<div class="card mb-3" data-v-db3478e0${_scopeId}><div class="card-body py-2 px-3" data-v-db3478e0${_scopeId}><div class="row g-2 align-items-center" data-v-db3478e0${_scopeId}><div class="col-12 col-sm-4 col-md-3" data-v-db3478e0${_scopeId}><div class="input-group input-group-sm" data-v-db3478e0${_scopeId}><span class="input-group-text" data-v-db3478e0${_scopeId}><i class="fa fa-search" data-v-db3478e0${_scopeId}></i></span><input type="text" class="form-control" placeholder="Buscar paciente..."${ssrRenderAttr("value", search.value)} data-v-db3478e0${_scopeId}>`);
            if (search.value) {
              _push2(`<button class="btn btn-outline-secondary" type="button" data-v-db3478e0${_scopeId}><i class="fa fa-times" data-v-db3478e0${_scopeId}></i></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="col-6 col-sm-3 col-md-2" data-v-db3478e0${_scopeId}><select class="form-select form-select-sm"${ssrRenderAttr("value", period.value)} data-v-db3478e0${_scopeId}><option value="hoje" data-v-db3478e0${_scopeId}>Hoje</option><option value="7" data-v-db3478e0${_scopeId}>Últimos 7 dias</option><option value="15" data-v-db3478e0${_scopeId}>Últimos 15 dias</option><option value="30" data-v-db3478e0${_scopeId}>Últimos 30 dias</option><option value="90" data-v-db3478e0${_scopeId}>Últimos 90 dias</option></select></div><div class="col-6 col-sm-auto" data-v-db3478e0${_scopeId}><button type="button" class="${ssrRenderClass([showFilters.value ? "btn-primary" : "btn-outline-secondary", "btn btn-sm"])}" data-v-db3478e0${_scopeId}><i class="fa fa-filter me-1" data-v-db3478e0${_scopeId}></i>Filtros `);
            if (!showFilters.value) {
              _push2(`<i class="fa fa-chevron-down ms-1" data-v-db3478e0${_scopeId}></i>`);
            } else {
              _push2(`<i class="fa fa-chevron-up ms-1" data-v-db3478e0${_scopeId}></i>`);
            }
            _push2(`</button></div><div class="col col-md d-flex justify-content-end" data-v-db3478e0${_scopeId}><button type="button" class="btn btn-primary btn-sm" data-v-db3478e0${_scopeId}><i class="fa fa-plus" data-v-db3478e0${_scopeId}></i> Novo </button></div></div><div class="row g-2 mt-1 pt-2 border-top align-items-center" style="${ssrRenderStyle(showFilters.value ? null : { display: "none" })}" data-v-db3478e0${_scopeId}><div class="col-auto" data-v-db3478e0${_scopeId}><div class="d-flex align-items-center gap-2" data-v-db3478e0${_scopeId}><span class="text-muted small fw-semibold" style="${ssrRenderStyle({ "white-space": "nowrap" })}" data-v-db3478e0${_scopeId}>Olho</span><div class="btn-group btn-group-sm" role="group" data-v-db3478e0${_scopeId}><input type="radio" class="btn-check" name="f-lat" id="f-lat-all" value=""${ssrIncludeBooleanAttr(ssrLooseEqual(laterality.value, "")) ? " checked" : ""} data-v-db3478e0${_scopeId}><label class="btn btn-outline-secondary" for="f-lat-all" data-v-db3478e0${_scopeId}>Todos</label><input type="radio" class="btn-check" name="f-lat" id="f-lat-od" value="od"${ssrIncludeBooleanAttr(ssrLooseEqual(laterality.value, "od")) ? " checked" : ""} data-v-db3478e0${_scopeId}><label class="btn btn-outline-primary" for="f-lat-od" data-v-db3478e0${_scopeId}>OD</label><input type="radio" class="btn-check" name="f-lat" id="f-lat-oe" value="oe"${ssrIncludeBooleanAttr(ssrLooseEqual(laterality.value, "oe")) ? " checked" : ""} data-v-db3478e0${_scopeId}><label class="btn btn-outline-danger" for="f-lat-oe" data-v-db3478e0${_scopeId}>OE</label><input type="radio" class="btn-check" name="f-lat" id="f-lat-ao" value="ao"${ssrIncludeBooleanAttr(ssrLooseEqual(laterality.value, "ao")) ? " checked" : ""} data-v-db3478e0${_scopeId}><label class="btn btn-outline-dark" for="f-lat-ao" data-v-db3478e0${_scopeId}>AO</label></div></div></div><div class="col-12 col-sm-6 col-md-3" data-v-db3478e0${_scopeId}><select class="form-select form-select-sm" data-v-db3478e0${_scopeId}><option value="" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(examTypeId.value) ? ssrLooseContain(examTypeId.value, "") : ssrLooseEqual(examTypeId.value, "")) ? " selected" : ""}${_scopeId}>Todos os exames</option><!--[-->`);
            ssrRenderList(availableExamTypes.value, (t) => {
              _push2(`<option${ssrRenderAttr("value", t.id)} data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(examTypeId.value) ? ssrLooseContain(examTypeId.value, t.id) : ssrLooseEqual(examTypeId.value, t.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(t.name)}</option>`);
            });
            _push2(`<!--]--></select></div><div class="col-12 col-sm-6 col-md-2" data-v-db3478e0${_scopeId}><select class="form-select form-select-sm" data-v-db3478e0${_scopeId}><option value="" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(examStatus.value) ? ssrLooseContain(examStatus.value, "") : ssrLooseEqual(examStatus.value, "")) ? " selected" : ""}${_scopeId}>Todos status</option><option value="solicitado" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(examStatus.value) ? ssrLooseContain(examStatus.value, "solicitado") : ssrLooseEqual(examStatus.value, "solicitado")) ? " selected" : ""}${_scopeId}>Solicitado</option><option value="realizado" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(examStatus.value) ? ssrLooseContain(examStatus.value, "realizado") : ssrLooseEqual(examStatus.value, "realizado")) ? " selected" : ""}${_scopeId}>Realizado</option><option value="laudado" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(examStatus.value) ? ssrLooseContain(examStatus.value, "laudado") : ssrLooseEqual(examStatus.value, "laudado")) ? " selected" : ""}${_scopeId}>Laudado</option><option value="cancelado" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(examStatus.value) ? ssrLooseContain(examStatus.value, "cancelado") : ssrLooseEqual(examStatus.value, "cancelado")) ? " selected" : ""}${_scopeId}>Cancelado</option></select></div><div class="col-12 col-sm-6 col-md-3" data-v-db3478e0${_scopeId}><select class="form-select form-select-sm"${ssrRenderAttr("value", doctorId.value)} data-v-db3478e0${_scopeId}><option value="" data-v-db3478e0${_scopeId}>Todos médicos</option><!--[-->`);
            ssrRenderList(__props.doctors, (d) => {
              _push2(`<option${ssrRenderAttr("value", d.id)} data-v-db3478e0${_scopeId}>${ssrInterpolate(d.name)}</option>`);
            });
            _push2(`<!--]--></select></div><div class="col-auto" data-v-db3478e0${_scopeId}><button type="button" class="btn btn-sm btn-outline-secondary" data-v-db3478e0${_scopeId}><i class="fa fa-times me-1" data-v-db3478e0${_scopeId}></i> Limpar </button></div></div></div></div><div class="row" data-v-db3478e0${_scopeId}><div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" data-v-db3478e0${_scopeId}><div class="card panel-info" data-v-db3478e0${_scopeId}><div class="card-body p-2" data-v-db3478e0${_scopeId}><h6 class="font-bold text-uppercase px-1 mb-1 mt-3" data-v-db3478e0${_scopeId}>Pacientes</h6><hr class="mt-0 mb-2" data-v-db3478e0${_scopeId}>`);
            if (loading.value) {
              _push2(`<div class="text-center py-3" data-v-db3478e0${_scopeId}><div class="spinner-border spinner-border-sm text-info" role="status" data-v-db3478e0${_scopeId}></div></div>`);
            } else {
              _push2(`<div style="${ssrRenderStyle({ "max-height": "520px", "overflow-y": "auto", "overflow-x": "hidden" })}" data-v-db3478e0${_scopeId}>`);
              if (filteredPatients.value.length === 0) {
                _push2(`<p class="text-muted text-center small py-3 mb-0" data-v-db3478e0${_scopeId}> Nenhum paciente encontrado. </p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--[-->`);
              ssrRenderList(filteredPatients.value, (patient) => {
                var _a2, _b2, _c2, _d;
                _push2(`<div class="${ssrRenderClass([{ "patient-item-active": ((_a2 = selectedPatient.value) == null ? void 0 : _a2.id) === patient.id }, "d-flex align-items-center gap-2 px-1 py-1 rounded mb-1 patient-item"])}" data-v-db3478e0${_scopeId}><div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0 text-white fw-bold" style="${ssrRenderStyle({ background: avatarColor(((_b2 = patient.person) == null ? void 0 : _b2.full_name) ?? patient.full_name), width: "30px", height: "30px", fontSize: ".62rem" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(initials(((_c2 = patient.person) == null ? void 0 : _c2.full_name) ?? patient.full_name))}</div><div class="flex-grow-1 min-w-0" data-v-db3478e0${_scopeId}><div class="text-truncate fw-semibold" style="${ssrRenderStyle({ "font-size": ".75rem", "line-height": "1.2" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(((_d = patient.person) == null ? void 0 : _d.full_name) ?? patient.full_name ?? "—")}</div><div class="text-muted" style="${ssrRenderStyle({ "font-size": ".65rem", "line-height": "1.2" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(patient.code)}</div></div><span class="badge bg-primary rounded-pill flex-shrink-0" style="${ssrRenderStyle({ "font-size": ".6rem" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(patient.exams.length)}</span></div>`);
              });
              _push2(`<!--]--></div>`);
            }
            if (!loading.value) {
              _push2(`<div class="text-muted px-1 mt-1" style="${ssrRenderStyle({ "font-size": ".65rem" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(filteredPatients.value.length)} paciente(s) </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="col-xs-12 col-sm-9 col-md-9 col-lg-9" data-v-db3478e0${_scopeId}><div class="card" data-v-db3478e0${_scopeId}><h5 class="card-header d-flex align-items-center gap-2" data-v-db3478e0${_scopeId}>`);
            if (!selectedPatient.value) {
              _push2(`<span data-v-db3478e0${_scopeId}>Selecione um paciente</span>`);
            } else {
              _push2(`<span class="d-flex align-items-center gap-2 w-100" data-v-db3478e0${_scopeId}><button type="button" class="btn btn-outline-secondary btn-sm" data-v-db3478e0${_scopeId}><i class="fa fa-arrow-left" data-v-db3478e0${_scopeId}></i></button><span data-v-db3478e0${_scopeId}><span data-v-db3478e0${_scopeId}>${ssrInterpolate(((_a = selectedPatient.value.person) == null ? void 0 : _a.full_name) ?? selectedPatient.value.full_name)}</span><small class="text-muted fw-normal ms-2" style="${ssrRenderStyle({ "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(selectedPatient.value.code)}</small></span><div class="flex-grow-1" data-v-db3478e0${_scopeId}></div><a${ssrRenderAttr("href", `/panel/patients/${selectedPatient.value.id}/medicalrecords`)} target="_blank" class="btn btn-outline-primary btn-sm" style="${ssrRenderStyle({ "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}> Prontuário <i class="fa fa-external-link ms-1" data-v-db3478e0${_scopeId}></i></a></span>`);
            }
            _push2(`</h5>`);
            if (selectedPatient.value) {
              _push2(`<div class="d-flex align-items-center gap-2 px-3 py-2 border-bottom bg-body-secondary" data-v-db3478e0${_scopeId}><button type="button" class="btn btn-sm btn-outline-primary"${ssrIncludeBooleanAttr(selectedExamIds.value.length === 0) ? " disabled" : ""} data-v-db3478e0${_scopeId}><i class="fa fa-images me-1" data-v-db3478e0${_scopeId}></i>Visualizar selecionados `);
              if (selectedExamIds.value.length > 0) {
                _push2(`<span class="badge bg-primary ms-1" data-v-db3478e0${_scopeId}>${ssrInterpolate(selectedExamIds.value.length)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</button><button type="button" class="btn btn-sm btn-outline-secondary" data-v-db3478e0${_scopeId}><i class="fa fa-th me-1" data-v-db3478e0${_scopeId}></i>Visualizar todos </button><div class="vr opacity-25" data-v-db3478e0${_scopeId}></div><button type="button" class="btn btn-sm btn-outline-dark" data-v-db3478e0${_scopeId}><i class="fa fa-print me-1" data-v-db3478e0${_scopeId}></i>Imprimir </button><div class="flex-grow-1" data-v-db3478e0${_scopeId}></div>`);
              if (selectedExamIds.value.length > 0) {
                _push2(`<span class="text-muted" style="${ssrRenderStyle({ "font-size": ".7rem" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(selectedExamIds.value.length)} selecionado(s) </span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            _push2(`<div class="card-body" data-v-db3478e0${_scopeId}>`);
            if (!selectedPatient.value) {
              _push2(`<div class="text-center py-5 text-muted" data-v-db3478e0${_scopeId}><i class="ti ti-eye" style="${ssrRenderStyle({ "font-size": "3rem", "opacity": ".3" })}" data-v-db3478e0${_scopeId}></i><p class="mt-3 mb-0" data-v-db3478e0${_scopeId}>Selecione um paciente para ver os exames.</p></div>`);
            } else {
              _push2(`<div class="row g-0" style="${ssrRenderStyle({ "min-height": "480px" })}" data-v-db3478e0${_scopeId}><div class="col-12 border-end pe-0" data-v-db3478e0${_scopeId}>`);
              if (urlsLoading.value) {
                _push2(`<div class="text-center py-3" data-v-db3478e0${_scopeId}><div class="spinner-border spinner-border-sm text-secondary" role="status" data-v-db3478e0${_scopeId}></div><p class="text-muted small mt-1 mb-0" data-v-db3478e0${_scopeId}>Carregando imagens...</p></div>`);
              } else if (filteredExams.value.length === 0) {
                _push2(`<p class="text-muted text-center small py-4" data-v-db3478e0${_scopeId}> Nenhum exame encontrado. </p>`);
              } else {
                _push2(`<div style="${ssrRenderStyle({ "max-height": "620px", "overflow-y": "auto", "overflow-x": "hidden" })}" data-v-db3478e0${_scopeId}><!--[-->`);
                ssrRenderList(groupedExams.value, (group) => {
                  var _a2;
                  _push2(`<div class="mb-1" data-v-db3478e0${_scopeId}><div class="px-2 py-1 d-flex align-items-center gap-1 flex-wrap bg-body-tertiary text-body border-bottom fw-semibold" style="${ssrRenderStyle({ "font-size": ".7rem", "row-gap": "3px" })}" data-v-db3478e0${_scopeId}><span data-v-db3478e0${_scopeId}>${ssrInterpolate(formatDateFull(group.date))}</span>`);
                  if (group.equipment) {
                    _push2(`<span class="d-flex align-items-center gap-1" data-v-db3478e0${_scopeId}><span class="opacity-50" data-v-db3478e0${_scopeId}>:</span><span data-v-db3478e0${_scopeId}>${ssrInterpolate(group.equipment.name)}</span></span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`<div class="flex-grow-1" data-v-db3478e0${_scopeId}></div><div class="btn-group btn-group-sm" role="group" data-v-db3478e0${_scopeId}><button type="button" class="${ssrRenderClass([groupLatActive(group, "od") ? "btn-primary" : "btn-outline-primary", "btn py-0 px-2"])}" style="${ssrRenderStyle({ "font-size": ".6rem" })}" data-v-db3478e0${_scopeId}>OD</button><button type="button" class="${ssrRenderClass([groupLatActive(group, "oe") ? "btn-danger" : "btn-outline-danger", "btn py-0 px-2"])}" style="${ssrRenderStyle({ "font-size": ".6rem" })}" data-v-db3478e0${_scopeId}>OE</button><button type="button" class="${ssrRenderClass([groupLatActive(group, "ao") ? "btn-secondary" : "btn-outline-secondary", "btn py-0 px-2"])}" style="${ssrRenderStyle({ "font-size": ".6rem" })}" data-v-db3478e0${_scopeId}>AO</button><button type="button" class="${ssrRenderClass([groupLatActive(group, "all") ? "btn-secondary" : "btn-outline-secondary", "btn py-0 px-2"])}" style="${ssrRenderStyle({ "font-size": ".6rem" })}" data-v-db3478e0${_scopeId}>Todos</button></div><div class="vr opacity-25 mx-1" data-v-db3478e0${_scopeId}></div><button type="button" class="btn btn-sm py-0 px-2 btn-outline-secondary" style="${ssrRenderStyle({ "font-size": ".6rem" })}" title="Upload de imagem" data-v-db3478e0${_scopeId}><i class="fa fa-upload me-1" data-v-db3478e0${_scopeId}></i>Upload </button><button type="button" class="btn btn-sm py-0 px-2 btn-outline-secondary" style="${ssrRenderStyle({ "font-size": ".6rem" })}" title="Download das imagens" data-v-db3478e0${_scopeId}><i class="fa fa-download me-1" data-v-db3478e0${_scopeId}></i>Download </button></div><div class="px-2 py-1 bg-body-secondary text-body-secondary border-bottom" style="${ssrRenderStyle({ "font-size": ".68rem" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(((_a2 = group.examType) == null ? void 0 : _a2.name) || "Exame")}</div><div class="d-flex flex-wrap gap-2 p-2 bg-dark" data-v-db3478e0${_scopeId}><!--[-->`);
                  ssrRenderList(group.exams, (exam) => {
                    var _a3;
                    _push2(`<div class="position-relative" style="${ssrRenderStyle({ "cursor": "pointer", "flex-shrink": "0" })}" data-v-db3478e0${_scopeId}><span class="${ssrRenderClass([{
                      "bg-primary": exam.laterality === 1,
                      "bg-danger": exam.laterality === 2,
                      "bg-secondary": exam.laterality !== 1 && exam.laterality !== 2
                    }, "position-absolute top-0 end-0 rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"])}" style="${ssrRenderStyle({ "width": "22px", "height": "22px", "font-size": ".55rem", "z-index": "1", "margin": "3px" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(latLabel(exam.laterality))}</span><span class="position-absolute bottom-0 start-0 d-flex align-items-center justify-content-center" style="${ssrRenderStyle({ "z-index": "2", "margin": "3px" })}" data-v-db3478e0${_scopeId}><span class="${ssrRenderClass([isSelected(exam.id) ? "bg-primary" : "bg-dark border border-secondary", "rounded d-flex align-items-center justify-content-center"])}" style="${ssrRenderStyle({ "width": "16px", "height": "16px" })}" data-v-db3478e0${_scopeId}><i class="fa fa-check text-white" style="${ssrRenderStyle([
                      { "font-size": ".5rem" },
                      isSelected(exam.id) ? null : { display: "none" }
                    ])}" data-v-db3478e0${_scopeId}></i></span></span>`);
                    if (examUrls.value[exam.id] && !brokenUrls.value[exam.id]) {
                      _push2(`<img${ssrRenderAttr("src", examUrls.value[exam.id])}${ssrRenderAttr("alt", (_a3 = exam.exam_type) == null ? void 0 : _a3.name)} width="100" height="76" style="${ssrRenderStyle(`object-fit:cover;display:block;border-radius:4px;outline:${isSelected(exam.id) ? "2px solid #6ea8fe" : "2px solid transparent"};transition:outline .1s;`)}" data-v-db3478e0${_scopeId}>`);
                    } else {
                      _push2(`<div class="d-flex align-items-center justify-content-center rounded" style="${ssrRenderStyle(`width:100px;height:76px;background:#3a3c42;border-radius:4px;outline:${isSelected(exam.id) ? "2px solid #6ea8fe" : "2px solid transparent"};transition:outline .1s;`)}" data-v-db3478e0${_scopeId}><i class="ti ti-photo-off" style="${ssrRenderStyle({ "font-size": "1.4rem", "color": "#555" })}" data-v-db3478e0${_scopeId}></i></div>`);
                    }
                    _push2(`</div>`);
                  });
                  _push2(`<!--]--></div></div>`);
            ...
            ssrRenderTeleport(_push2, (_push3) => {
              ...
              ])}" data-v-db3478e0${_scopeId}><div class="d-flex align-items-center gap-1 px-3 py-2 flex-shrink-0 flex-wrap" style="${ssrRenderStyle({ "background": "#111", "border-bottom": "1px solid #222", "row-gap": "4px" })}" data-v-db3478e0${_scopeId}><div class="btn-group btn-group-sm" role="group" data-v-db3478e0${_scopeId}><!--[-->`);
              ssrRenderList([1, 2, 3, 4], (n) => {
                _push3(`<button type="button" class="${ssrRenderClass([viewerPanelCount.value === n ? "btn-primary" : "btn-outline-secondary", "btn fw-semibold"])}" style="${ssrRenderStyle({ "min-width": "26px", "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(n)}</button>`);
              });
              _push3(`<!--]--></div><div class="vr opacity-25 mx-1" data-v-db3478e0${_scopeId}></div><button type="button" class="${ssrRenderClass([viewerAllMode.value ? "btn-info text-dark" : "btn-outline-secondary", "btn btn-sm fw-semibold"])}" style="${ssrRenderStyle({ "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}>All</button><div class="vr opacity-25 mx-1" data-v-db3478e0${_scopeId}></div><button type="button" class="${ssrRenderClass([viewerLensActive.value ? "btn-warning text-dark" : "btn-outline-secondary", "btn btn-sm fw-semibold"])}" style="${ssrRenderStyle({ "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}><i class="fa fa-search-plus" data-v-db3478e0${_scopeId}></i> Lens </button>`);
              if (viewerLensActive.value) {
                _push3(`<div class="d-flex align-items-center gap-1" data-v-db3478e0${_scopeId}><button type="button" class="btn btn-sm btn-outline-secondary py-0 px-1" data-v-db3478e0${_scopeId}><i class="fa fa-minus" style="${ssrRenderStyle({ "font-size": ".65rem" })}" data-v-db3478e0${_scopeId}></i></button><span style="${ssrRenderStyle({ "color": "#fff", "font-size": ".78rem", "font-weight": "600", "min-width": "48px", "text-align": "center", "display": "inline-block" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(viewerZoom.value.toFixed(1))}x </span><button type="button" class="btn btn-sm btn-outline-secondary py-0 px-1" data-v-db3478e0${_scopeId}><i class="fa fa-plus" style="${ssrRenderStyle({ "font-size": ".65rem" })}" data-v-db3478e0${_scopeId}></i></button></div>`);
              } else {
                _push3(`<!---->`);
              }
              _push3(`<div class="vr opacity-25 mx-1" data-v-db3478e0${_scopeId}></div><button type="button" class="${ssrRenderClass([viewerFitMode.value ? "btn-light text-dark" : "btn-outline-secondary", "btn btn-sm fw-semibold"])}" style="${ssrRenderStyle({ "font-size": ".72rem" })}" title="Ajustar à área de visualização" data-v-db3478e0${_scopeId}><i class="fa fa-compress-arrows-alt me-1" data-v-db3478e0${_scopeId}></i>Fit </button><button type="button" class="${ssrRenderClass([viewerSplitMode.value ? "btn-info text-dark" : "btn-outline-secondary", "btn btn-sm fw-semibold"])}" style="${ssrRenderStyle({ "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}>OD|OE</button><button type="button" class="${ssrRenderClass([viewerLaserMode.value ? "btn-success" : "btn-outline-secondary", "btn btn-sm fw-semibold"])}" style="${ssrRenderStyle({ "font-size": ".72rem" })}" title="Inverter imagem verticalmente" data-v-db3478e0${_scopeId}><i class="fa fa-undo me-1" data-v-db3478e0${_scopeId}></i>Laser </button><div class="vr opacity-25 mx-1" data-v-db3478e0${_scopeId}></div><div class="flex-grow-1" data-v-db3478e0${_scopeId}></div><button type="button" class="btn btn-sm btn-outline-danger" data-v-db3478e0${_scopeId}><i class="fa fa-times" data-v-db3478e0${_scopeId}></i></button></div><div class="flex-grow-1" style="${ssrRenderStyle([
                viewerPanelGridStyle.value,
                !viewerAllMode.value ? null : { display: "none" }
              ])}" data-v-db3478e0${_scopeId}><!--[-->`);
              ssrRenderList(viewerPanelCount.value, (pi) => {
                var _a2, _b2;
                _push3(`<div class="position-relative d-flex flex-column" style="${ssrRenderStyle(`background:#111;border-radius:3px;min-height:0;cursor:pointer;overflow:hidden;outline:${viewerActivePanel.value === pi - 1 ? "2px solid #0d6efd" : "1px solid #2a2a2a"};`)}" data-v-db3478e0${_scopeId}><div class="${ssrRenderClass([viewerFitMode.value ? "align-items-start justify-content-center" : "align-items-center justify-content-center", "flex-grow-1 position-relative d-flex"])}" style="${ssrRenderStyle((viewerFitMode.value ? "height:84vh;min-height:0;overflow-y:auto;overflow-x:hidden;" : "min-height:0;overflow:hidden;") + (viewerLensActive.value && viewerPanelUrls.value[pi - 1] && !viewerPanelBroken.value[pi - 1] ? "cursor:none;" : ""))}" data-v-db3478e0${_scopeId}><div class="text-center text-white position-absolute" style="${ssrRenderStyle([
                  { "z-index": "5" },
                  viewerPanelLoading.value[pi - 1] ? null : { display: "none" }
                ])}" data-v-db3478e0${_scopeId}><div class="spinner-border spinner-border-sm text-light" role="status" data-v-db3478e0${_scopeId}></div></div><div class="text-center text-muted" style="${ssrRenderStyle(!viewerPanelExams.value[pi - 1] && !viewerPanelLoading.value[pi - 1] ? null : { display: "none" })}" data-v-db3478e0${_scopeId}><i class="ti ti-photo" style="${ssrRenderStyle({ "font-size": "2.5rem", "opacity": ".12" })}" data-v-db3478e0${_scopeId}></i><p class="mt-1 mb-0" style="${ssrRenderStyle({ "font-size": ".65rem", "opacity": ".35" })}" data-v-db3478e0${_scopeId}>Painel ${ssrInterpolate(pi)}</p></div><div class="text-center text-muted" style="${ssrRenderStyle(viewerPanelExams.value[pi - 1] && !viewerPanelUrls.value[pi - 1] && !viewerPanelLoading.value[pi - 1] && !viewerPanelBroken.value[pi - 1] ? null : { display: "none" })}" data-v-db3478e0${_scopeId}><i class="ti ti-photo-off" style="${ssrRenderStyle({ "font-size": "2rem", "opacity": ".3" })}" data-v-db3478e0${_scopeId}></i><p class="mt-1 mb-0" style="${ssrRenderStyle({ "font-size": ".65rem" })}" data-v-db3478e0${_scopeId}>Sem imagem</p></div><div class="text-center text-muted" style="${ssrRenderStyle(viewerPanelBroken.value[pi - 1] ? null : { display: "none" })}" data-v-db3478e0${_scopeId}><i class="ti ti-photo-off" style="${ssrRenderStyle({ "font-size": "2rem", "opacity": ".3" })}" data-v-db3478e0${_scopeId}></i><p class="mt-1 mb-0" style="${ssrRenderStyle({ "font-size": ".65rem" })}" data-v-db3478e0${_scopeId}>Arquivo não encontrado</p></div><img${ssrRenderAttr("src", viewerPanelUrls.value[pi - 1] ?? "")} alt="Exame" style="${ssrRenderStyle([
                ...
                ])}" data-v-db3478e0${_scopeId}></div><div class="d-flex align-items-center gap-1 px-2 flex-shrink-0" style="${ssrRenderStyle({ "background": "#0d0d0d", "font-size": ".6rem", "min-height": "22px", "border-top": "1px solid #1a1a1a" })}" data-v-db3478e0${_scopeId}>`);
                if (viewerPanelExams.value[pi - 1]) {
                  _push3(`<span class="d-flex align-items-center gap-1 overflow-hidden w-100" data-v-db3478e0${_scopeId}><span class="${ssrRenderClass([{
                  ...
                  }, "badge flex-shrink-0"])}" style="${ssrRenderStyle({ "font-size": ".5rem" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(latLabel(viewerPanelExams.value[pi - 1].laterality))}</span><span class="text-secondary text-truncate" data-v-db3478e0${_scopeId}>${ssrInterpolate(((_a2 = viewerPanelExams.value[pi - 1].exam_type) == null ? void 0 : _a2.name) ?? "—")}</span><span class="text-secondary opacity-50 flex-shrink-0 ms-auto" data-v-db3478e0${_scopeId}>${ssrInterpolate(formatDateFull((_b2 = viewerPanelExams.value[pi - 1].created_at) == null ? void 0 : _b2.substring(0, 10)))}</span></span>`);
                } else {
                  _push3(`<span class="text-secondary" style="${ssrRenderStyle({ "opacity": ".3" })}" data-v-db3478e0${_scopeId}>Painel ${ssrInterpolate(pi)}</span>`);
                }
                _push3(`</div><div class="flex-shrink-0 d-flex align-items-center gap-1 overflow-x-auto overflow-y-hidden py-1 px-1" style="${ssrRenderStyle(`background:#0d0d0d;height:80px;border-top:1px solid ${viewerActivePanel.value === pi - 1 ? "#0d6efd" : "#222"};`)}" data-v-db3478e0${_scopeId}><!--[-->`);
                ssrRenderList(panelStripExams(pi - 1), (exam) => {
                  var _a3;
                  _push3(`<div style="${ssrRenderStyle({ "flex-shrink": "0", "cursor": "pointer" })}" data-v-db3478e0${_scopeId}><div class="position-relative rounded overflow-hidden" style="${ssrRenderStyle(`width:64px;height:64px;outline:${((_a3 = viewerPanelExams.value[pi - 1]) == null ? void 0 : _a3.id) === exam.id ? "2px solid #0d6efd" : "1px solid #2a2a2a"};`)}" data-v-db3478e0${_scopeId}><span class="${ssrRenderClass([{
                    "bg-primary": exam.laterality === 1,
                    "bg-danger": exam.laterality === 2,
                    "bg-secondary": exam.laterality !== 1 && exam.laterality !== 2
                  }, "position-absolute top-0 end-0 rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"])}" style="${ssrRenderStyle({ "width": "14px", "height": "14px", "font-size": ".4rem", "z-index": "1", "margin": "2px" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(latLabel(exam.laterality))}</span>`);
                  if (examUrls.value[exam.id] && !brokenUrls.value[exam.id]) {
                    _push3(`<img${ssrRenderAttr("src", examUrls.value[exam.id])} style="${ssrRenderStyle({ "width": "64px", "height": "64px", "object-fit": "cover", "display": "block" })}" data-v-db3478e0${_scopeId}>`);
                  } else {
                    _push3(`<div class="w-100 h-100 d-flex align-items-center justify-content-center" style="${ssrRenderStyle({ "background": "#1a1a1a" })}" data-v-db3478e0${_scopeId}><i class="ti ti-photo-off" style="${ssrRenderStyle({ "color": "#444", "font-size": ".9rem" })}" data-v-db3478e0${_scopeId}></i></div>`);
                  }
                  _push3(`</div></div>`);
                });
                _push3(`<!--]--></div></div>`);
              ...
              _push3(`<!--]--></div><div id="viewImages" class="ei-scroll" style="${ssrRenderStyle([
                ...
                viewerAllMode.value ? null : { display: "none" }
              ])}" data-v-db3478e0${_scopeId}><div style="${ssrRenderStyle(`display:grid;grid-template-columns:repeat(${viewerSplitMode.value ? 2 : viewerPanelCount.value},1fr);gap:4px;`)}" data-v-db3478e0${_scopeId}><!--[-->`);
              ssrRenderList(allGridExams(), (exam) => {
                var _a2;
                _push3(`<div class="position-relative" style="${ssrRenderStyle({ "background": "#111", "border-radius": "3px", "overflow": "hidden", "display": "flex", "flex-direction": "column" })}" data-v-db3478e0${_scopeId}><div class="d-flex align-items-center gap-2 px-2 py-1" style="${ssrRenderStyle({ "background": "#0d0d0d", "border-bottom": "1px solid #1a1a1a", "font-size": ".65rem" })}" data-v-db3478e0${_scopeId}><span class="${ssrRenderClass([{
                  "bg-primary": exam.laterality === 1,
                  "bg-danger": exam.laterality === 2,
                  "bg-secondary": exam.laterality !== 1 && exam.laterality !== 2
                }, "badge flex-shrink-0"])}" style="${ssrRenderStyle({ "font-size": ".5rem" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(latLabel(exam.laterality))}</span><span class="text-secondary text-truncate" data-v-db3478e0${_scopeId}>${ssrInterpolate(((_a2 = exam.exam_type) == null ? void 0 : _a2.name) ?? "—")}</span><span class="text-secondary opacity-50 flex-shrink-0 ms-auto" data-v-db3478e0${_scopeId}>${ssrInterpolate(formatDateTime(exam.created_at))}</span></div><div class="position-relative" style="${ssrRenderStyle(viewerLensActive.value && examUrls.value[exam.id] && !brokenUrls.value[exam.id] ? "cursor:none;" : "")}" data-v-db3478e0${_scopeId}>`);
                if (examUrls.value[exam.id] && !brokenUrls.value[exam.id]) {
                  _push3(`<img${ssrRenderAttr("src", examUrls.value[exam.id])} style="${ssrRenderStyle("width:100%;height:auto;display:block;user-select:none;" + (viewerLaserMode.value ? "transform:scaleY(-1);" : ""))}" data-v-db3478e0${_scopeId}>`);
                } else {
                  _push3(`<div class="d-flex align-items-center justify-content-center" style="${ssrRenderStyle({ "width": "100%", "aspect-ratio": "4/3", "background": "#1a1a1a" })}" data-v-db3478e0${_scopeId}><i class="ti ti-photo-off" style="${ssrRenderStyle({ "color": "#444", "font-size": "2rem" })}" data-v-db3478e0${_scopeId}></i></div>`);
                }
                _push3(`</div></div>`);
              });
              ...
              ])}" data-v-db3478e0${_scopeId}></div></div>`);
            }, "body", false, _parent2);
            ssrRenderTeleport(_push2, (_push3) => {
              var _a2;
              _push3(`<div style="${ssrRenderStyle([
              ...
              ])}" data-v-db3478e0${_scopeId}><div class="d-flex align-items-center gap-1 px-3 py-2 flex-shrink-0" style="${ssrRenderStyle({ "background": "#2c2c2c", "color": "#fff" })}" data-v-db3478e0${_scopeId}><div class="btn-group btn-group-sm me-2" role="group" data-v-db3478e0${_scopeId}><!--[-->`);
              ssrRenderList([1, 2, 4, 6, 9, 12, 16], (n) => {
                _push3(`<button type="button" class="${ssrRenderClass([printCols.value === n ? "btn-light" : "btn-outline-secondary", "btn btn-sm"])}" style="${ssrRenderStyle({ "font-size": ".72rem", "min-width": "28px" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(n)}</button>`);
              });
              _push3(`<!--]--></div><div class="vr opacity-25 mx-1" data-v-db3478e0${_scopeId}></div><button type="button" class="${ssrRenderClass([printOrientation.value === "portrait" ? "btn-light" : "btn-outline-secondary", "btn btn-sm"])}" style="${ssrRenderStyle({ "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}><i class="fa fa-file me-1" data-v-db3478e0${_scopeId}></i>Retrato </button><button type="button" class="${ssrRenderClass([printOrientation.value === "landscape" ? "btn-light" : "btn-outline-secondary", "btn btn-sm"])}" style="${ssrRenderStyle({ "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}><i class="fa fa-file me-1" style="${ssrRenderStyle({ "transform": "rotate(90deg)", "display": "inline-block" })}" data-v-db3478e0${_scopeId}></i>Paisagem </button><div class="vr opacity-25 mx-1" data-v-db3478e0${_scopeId}></div><button type="button" class="btn btn-sm btn-warning text-dark fw-semibold" style="${ssrRenderStyle({ "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}><i class="fa fa-print me-1" data-v-db3478e0${_scopeId}></i>Imprimir </button><button type="button" class="btn btn-sm btn-outline-secondary ms-auto" style="${ssrRenderStyle({ "font-size": ".72rem" })}" data-v-db3478e0${_scopeId}><i class="fa fa-times me-1" data-v-db3478e0${_scopeId}></i>Fechar </button></div><div class="flex-grow-1 overflow-auto" style="${ssrRenderStyle({ "background": "#888" })}" data-v-db3478e0${_scopeId}><div id="ei-print-content" class="${ssrRenderClass([printOrientation.value === "landscape" ? "ei-landscape" : "ei-portrait", "mx-auto my-3 bg-white shadow"])}" style="${ssrRenderStyle({ "width": "210mm", "min-height": "297mm", "padding": "12mm", "box-sizing": "border-box" })}" data-v-db3478e0${_scopeId}><div class="d-flex justify-content-between align-items-start mb-3 pb-2" style="${ssrRenderStyle({ "border-bottom": "2px solid #1a6fc4" })}" data-v-db3478e0${_scopeId}><div data-v-db3478e0${_scopeId}><div style="${ssrRenderStyle({ "font-size": "1.1rem", "font-weight": "700", "color": "#1a6fc4" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(printEntity.value.name)}</div>`);
              if (printEntity.value.address) {
                _push3(`<div style="${ssrRenderStyle({ "font-size": ".72rem", "color": "#555" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(printEntity.value.address)}</div>`);
              } else {
                _push3(`<!---->`);
              }
              if (printEntity.value.email) {
                _push3(`<div style="${ssrRenderStyle({ "font-size": ".72rem", "color": "#555" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(printEntity.value.email)}</div>`);
              } else {
                _push3(`<!---->`);
              }
              if (printEntity.value.telephone || printEntity.value.cellphone) {
                _push3(`<div style="${ssrRenderStyle({ "font-size": ".72rem", "color": "#555" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate([printEntity.value.telephone, printEntity.value.cellphone].filter(Boolean).join(" | "))}</div>`);
              } else {
                _push3(`<!---->`);
              }
              _push3(`</div><div class="text-end" data-v-db3478e0${_scopeId}><div style="${ssrRenderStyle({ "font-size": ".72rem", "color": "#555" })}" data-v-db3478e0${_scopeId}>Data do relatório</div><div style="${ssrRenderStyle({ "font-size": ".85rem", "font-weight": "600" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate((/* @__PURE__ */ new Date()).toLocaleDateString("pt-BR"))}</div></div></div>`);
              if (selectedPatient.value) {
                _push3(`<div class="mb-3 p-2 rounded" style="${ssrRenderStyle({ "background": "#f0f4ff", "font-size": ".78rem" })}" data-v-db3478e0${_scopeId}><strong data-v-db3478e0${_scopeId}>${ssrInterpolate(((_a2 = selectedPatient.value.person) == null ? void 0 : _a2.full_name) ?? selectedPatient.value.full_name)}</strong><span class="ms-2 text-muted" data-v-db3478e0${_scopeId}>${ssrInterpolate(selectedPatient.value.code)}</span></div>`);
              } else {
                _push3(`<!---->`);
              }
              _push3(`<div style="${ssrRenderStyle(`display:grid;grid-template-columns:repeat(${printCols.value},1fr);gap:8px;`)}" data-v-db3478e0${_scopeId}><!--[-->`);
              ssrRenderList(printExams.value, (exam) => {
                var _a3;
                _push3(`<div style="${ssrRenderStyle({ "break-inside": "avoid" })}" data-v-db3478e0${_scopeId}><div class="text-center mb-1" style="${ssrRenderStyle({ "font-size": ".65rem", "color": "#333", "font-weight": "600" })}" data-v-db3478e0${_scopeId}>${ssrInterpolate(((_a3 = exam.exam_type) == null ? void 0 : _a3.name) ?? "Exame")} - ${ssrInterpolate(latLabel(exam.laterality))} - ${ssrInterpolate(formatDateTime(exam.created_at))}</div>`);
                if (examUrls.value[exam.id] && !brokenUrls.value[exam.id]) {
                  _push3(`<img${ssrRenderAttr("src", examUrls.value[exam.id])} style="${ssrRenderStyle({ "width": "100%", "height": "auto", "display": "block", "border": "1px solid #ddd" })}" data-v-db3478e0${_scopeId}>`);
                } else {
                  _push3(`<div class="d-flex align-items-center justify-content-center" style="${ssrRenderStyle({ "width": "100%", "aspect-ratio": "4/3", "background": "#eee", "border": "1px solid #ddd" })}" data-v-db3478e0${_scopeId}><i class="ti ti-photo-off" style="${ssrRenderStyle({ "font-size": "2rem", "color": "#aaa" })}" data-v-db3478e0${_scopeId}></i></div>`);
                }
                _push3(`</div>`);
              });
            ...
            if (aiModalOpen.value) {
              _push2(`<div class="modal d-block" tabindex="-1" style="${ssrRenderStyle({ "background": "rgba(0,0,0,.55)" })}" data-v-db3478e0${_scopeId}><div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" data-v-db3478e0${_scopeId}><div class="modal-content" data-v-db3478e0${_scopeId}><div class="modal-header" data-v-db3478e0${_scopeId}><h5 class="modal-title" data-v-db3478e0${_scopeId}><i class="ti ti-robot me-1 text-info" data-v-db3478e0${_scopeId}></i> ${ssrInterpolate(aiLabel("title", "Assistente de IA"))}</h5><button type="button" class="btn-close" data-v-db3478e0${_scopeId}></button></div><div class="modal-body" data-v-db3478e0${_scopeId}><div class="d-flex flex-wrap gap-3 mb-3 small text-muted" data-v-db3478e0${_scopeId}><span data-v-db3478e0${_scopeId}><strong data-v-db3478e0${_scopeId}>${ssrInterpolate(aiBalance.available)}</strong> ${ssrInterpolate(aiLabel("credits_available", "Créditos disponíveis"))}</span><span class="text-warning" data-v-db3478e0${_scopeId}><strong data-v-db3478e0${_scopeId}>${ssrInterpolate(aiBalance.reserved)}</strong> ${ssrInterpolate(aiLabel("credits_reserved", "Reservados"))}</span></div><div class="alert alert-info py-2 small" data-v-db3478e0${_scopeId}><i class="ti ti-info-circle me-1" data-v-db3478e0${_scopeId}></i>${ssrInterpolate(aiLabel("support_notice", "A IA é apoio clínico. A decisão final é sempre do médico responsável."))}</div>`);
              if (aiAlert.message) {
                _push2(`<div class="${ssrRenderClass(`alert alert-${aiAlert.type}`)}" role="alert" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiAlert.message)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="row g-2 mb-3" data-v-db3478e0${_scopeId}><div class="col-md-6" data-v-db3478e0${_scopeId}><label class="form-label small" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiLabel("workflow", "Workflow"))}</label><select class="form-select form-select-sm" data-v-db3478e0${_scopeId}><!--[-->`);
              ssrRenderList(aiWorkflows.value, (workflow) => {
                _push2(`<option${ssrRenderAttr("value", workflow)} data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(aiForm.workflow) ? ssrLooseContain(aiForm.workflow, workflow) : ssrLooseEqual(aiForm.workflow, workflow)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(aiWorkflowLabel(workflow))}</option>`);
              });
              _push2(`<!--]--></select></div><div class="col-md-6" data-v-db3478e0${_scopeId}><label class="form-label small" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiLabel("risk", "Risco"))}</label><select class="form-select form-select-sm" data-v-db3478e0${_scopeId}><option value="low" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(aiForm.risk_level) ? ssrLooseContain(aiForm.risk_level, "low") : ssrLooseEqual(aiForm.risk_level, "low")) ? " selected" : ""}${_scopeId}>${ssrInterpolate(aiLabel("risk_low", "Baixo"))}</option><option value="medium" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(aiForm.risk_level) ? ssrLooseContain(aiForm.risk_level, "medium") : ssrLooseEqual(aiForm.risk_level, "medium")) ? " selected" : ""}${_scopeId}>${ssrInterpolate(aiLabel("risk_medium", "Médio"))}</option><option value="high" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(aiForm.risk_level) ? ssrLooseContain(aiForm.risk_level, "high") : ssrLooseEqual(aiForm.risk_level, "high")) ? " selected" : ""}${_scopeId}>${ssrInterpolate(aiLabel("risk_high", "Alto"))}</option></select></div></div><div class="mb-3" data-v-db3478e0${_scopeId}><label class="form-label small" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiLabel("patient_optional", "Patient (optional)"))}</label><select class="form-select form-select-sm" data-v-db3478e0${_scopeId}><option value="" data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(aiForm.patient_id) ? ssrLooseContain(aiForm.patient_id, "") : ssrLooseEqual(aiForm.patient_id, "")) ? " selected" : ""}${_scopeId}>${ssrInterpolate(aiLabel("select_placeholder", "Select"))}</option><!--[-->`);
              ssrRenderList(aiPatients.value, (p) => {
                _push2(`<option${ssrRenderAttr("value", p.id)} data-v-db3478e0${ssrIncludeBooleanAttr(Array.isArray(aiForm.patient_id) ? ssrLooseContain(aiForm.patient_id, p.id) : ssrLooseEqual(aiForm.patient_id, p.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(p.name)} (${ssrInterpolate(p.code)})</option>`);
              });
              _push2(`<!--]--></select></div><div class="mb-3" data-v-db3478e0${_scopeId}><label class="form-label fw-semibold" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiLabel("clinical_prompt", "Prompt clínico"))}</label><textarea class="form-control" rows="5" minlength="12" maxlength="30000"${ssrRenderAttr("placeholder", aiLabel("clinical_prompt_placeholder", "Descreva o contexto e objetivo clínico."))} data-v-db3478e0${_scopeId}>${ssrInterpolate(aiForm.user_prompt)}</textarea></div><div class="mb-3" data-v-db3478e0${_scopeId}><label class="form-label small" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiLabel("system_prompt", "System prompt"))}</label><textarea class="form-control form-control-sm" rows="2" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiForm.system_prompt)}</textarea></div>`);
              if (aiEstimate.value) {
                _push2(`<div class="border rounded p-2 bg-light small" data-v-db3478e0${_scopeId}><div class="d-flex justify-content-between align-items-center" data-v-db3478e0${_scopeId}><span data-v-db3478e0${_scopeId}><strong data-v-db3478e0${_scopeId}>${ssrInterpolate(aiLabel("estimated_credits", "Créditos estimados"))}:</strong> ${ssrInterpolate(aiEstimate.value.normalized_credits ?? "—")}</span><span class="text-muted" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiLabel("raw_cost_usd", "Custo bruto USD"))}: ${ssrInterpolate(aiEstimate.value.raw_cost_usd ?? "—")}</span></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div><div class="modal-footer" data-v-db3478e0${_scopeId}><button type="button" class="btn btn-outline-secondary btn-sm" data-v-db3478e0${_scopeId}>${ssrInterpolate(aiLabel("close", "Close"))}</button><button type="button" class="btn btn-outline-info btn-sm"${ssrIncludeBooleanAttr(aiEstimating.value) ? " disabled" : ""} data-v-db3478e0${_scopeId}>`);
              if (aiEstimating.value) {
                _push2(`<span class="spinner-border spinner-border-sm me-1" data-v-db3478e0${_scopeId}></span>`);
              } else {
                _push2(`<i class="ti ti-calculator me-1" data-v-db3478e0${_scopeId}></i>`);
              }
              _push2(`${ssrInterpolate(aiLabel("estimate", "Estimar Custo"))}</button><button type="button" class="btn btn-success btn-sm"${ssrIncludeBooleanAttr(aiSubmitting.value || !aiEstimate.value) ? " disabled" : ""} data-v-db3478e0${_scopeId}>`);
              if (aiSubmitting.value) {
                _push2(`<span class="spinner-border spinner-border-sm me-1" data-v-db3478e0${_scopeId}></span>`);
              } else {
                _push2(`<i class="ti ti-player-play me-1" data-v-db3478e0${_scopeId}></i>`);
              }
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(filteredPatients.value, (patient) => {
                          ...
                          return openBlock(), createBlock("div", {
                            ...
                            createVNode("div", { class: "flex-grow-1 min-w-0" }, [
                              ...
                              }, toDisplayString(((_d = patient.person) == null ? void 0 : _d.full_name) ?? patient.full_name ?? "—"), 1),
                              createVNode("div", {
                                class: "text-muted",
                    ...
                    createVNode("h5", { class: "card-header d-flex align-items-center gap-2" }, [
                      !selectedPatient.value ? (openBlock(), createBlock("span", { key: 0 }, "Selecione um paciente")) : (openBlock(), createBlock("span", {
                        ...
                        createVNode("span", null, [
                          createVNode("span", null, toDisplayString(((_b = selectedPatient.value.person) == null ? void 0 : _b.full_name) ?? selectedPatient.value.full_name), 1),
                          createVNode("small", {
                  ...
                  createVNode("div", {
                    ...
                    createVNode("div", {
                      ...
                      selectedPatient.value ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("strong", null, toDisplayString(((_c = selectedPatient.value.person) == null ? void 0 : _c.full_name) ?? selectedPatient.value.full_name), 1),
                    ...
                    createVNode("div", { class: "modal-body" }, [
                      ...
                      aiEstimate.value ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "d-flex justify-content-between align-items-center" }, [
                          ...
                          createVNode("span", { class: "text-muted" }, toDisplayString(aiLabel("raw_cost_usd", "Custo bruto USD")) + ": " + toDisplayString(aiEstimate.value.raw_cost_usd ?? "—"), 1)
                        ])
                      ])) : createCommentVNode("", true)
                    ]),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-db3478e0"]]);
export {
  Index as default
};
