...
import _sfc_main$3 from "./PlanTable-B8Gqv8xW.js";
import _sfc_main$4 from "./PlanCards-vsi_jCQF.js";
import _sfc_main$5 from "./PlanFormModal-CIb1WujJ.js";
import PlanDetailDrawer from "./PlanDetailDrawer-DF-im0r8.js";
          ...
          if (_push2) {
            ...
            if (view.value === "table") {
              ...
              _push2(ssrRenderComponent(_sfc_main$4, {
                "cards-url": _ctx.route("manager.plans.cards"),
            ...
            _push2(ssrRenderComponent(PlanDetailDrawer, {
              open: detailOpen.value,
              "plan-id": detailId.value,
              t: __props.t,
              onClose: closeDetail,
              onEdit: (id) => {
                closeDetail();
            ...
            return [
              createVNode("div", null, [
                ...
                view.value === "table" ? (openBlock(), createBlock(_sfc_main$3, {
                  ...
                  onDelete,
                  onToggleActive
                }, null, 8, ["plans", "filters", "t"])) : (openBlock(), createBlock(_sfc_main$4, {
                  key: 1,
                  "cards-url": _ctx.route("manager.plans.cards"),
                  "initial-search": search.value,
                  t: __props.t,
              ...
              createVNode(_sfc_main$5, {
                ...
                t: __props.t,
                onClose: closeForm
              }, null, 8, ["open", "plan-id", "features", "billing-cycles", "t"]),
              createVNode(PlanDetailDrawer, {
                open: detailOpen.value,
                "plan-id": detailId.value,
                t: __props.t,
                onClose: closeDetail,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Panel/Manager/Plans/Index.vue");
