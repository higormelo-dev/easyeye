...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "card mgr-chart-card h-100" }, _attrs))}><div class="card-header"><i class="ti ti-building-plus me-2"></i>${ssrInterpolate(__props.t.chart_growth)}</div><div class="card-body"><canvas style="${ssrRenderStyle({ "height": "240px", "max-height": "240px" })}"></canvas></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Panel/ManagerDashboard/GrowthChart.vue");
