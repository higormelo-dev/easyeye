...
return [
    ...
    'token_scope_insufficient' => 'O token não tem permissão para esta operação',
    'idempotency_key_invalid'  => 'Idempotency-Key inválido (use 8 a 128 caracteres: letras, números, hífen ou underscore)',
    'idempotency_in_progress'  => 'Uma requisição com este Idempotency-Key ainda está em processamento',
