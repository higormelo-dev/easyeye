...
return [
    ...
    'subtitle' => 'Gerencie créditos IA por provedor (ChatGPT, Claude, Gemini) — aprove pedidos, lance créditos manuais ou monitore consumo.',
    ...
    'actions' => [
        ...
        'create_manual'   => 'Adicionar crédito manual',
    ...
    'manual' => [
        ...
        'amount_cents'   => 'Valor de referência (R$, opcional)',
        'amount_help'    => 'Use 0 para cortesia. Caso queira registrar o valor monetário equivalente (relatório financeiro), informe em centavos.',
