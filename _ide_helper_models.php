...
namespace App\Models{
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $deleted_at
     * @property string|null $token_session
     * @property \Illuminate\Support\Carbon|null $token_session_expires_at
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegrator whereEntityId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegrator whereToken($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegrator whereTokenSession($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegrator whereTokenSessionExpiresAt($value)
...
namespace App\Models{
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereActive($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereDeletedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereIntegratorId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereIp($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereMac($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereSerialNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|EntityIntegratorEquipment whereUpdatedAt($value)
...
namespace App\Models{
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<static>|Schedule whereVisits($value)
...
namespace App\Models{
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<static>|VisualAcuity whereActive($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|VisualAcuity whereCode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|VisualAcuity whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|VisualAcuity whereDeletedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|VisualAcuity whereEntityId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|VisualAcuity whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|VisualAcuity whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|VisualAcuity whereScale($value)
     * @method static \Illuminate\Database\Eloquent\Builder<static>|VisualAcuity whereUpdatedAt($value)
     */
