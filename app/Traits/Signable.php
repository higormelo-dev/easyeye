...
trait Signable
{
    ...
    public function sign(EntityUser $entityUser): void
    {
        ...
        // Hash garante integridade: qualquer alteração posterior geraria um hash diferente
        $contentHash = hash('sha256', serialize($this->getAttributes()));
     ...
     * Compara o hash armazenado com o hash recalculado do conteúdo atual.
