...
class VisitTypesDataTable extends BaseDataTable
{
    /**
     ...
     */
    public function query(VisitType $model): Builder
    {
        return $model->newQuery()
            ...
            ->orWhere(function ($query) {
                $query->whereNull('visit_types.entity_id')
    ...
    {
        return $this->builder()
            ->setTableId('visittypes_datatable')
    ...
    {
        return 'VisitTypes_' . date('YmdHis');
    }
}
