...
class ReportSettingsDataTable extends BaseDataTable
{
    public function dataTable(Builder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', fn (ReportSetting $record) => $this->buildReportSettingActionButtons($record))
    ...
    {
        return $this->builder()
            ->setTableId('report_settings_datatable')
    ...
    {
        return 'ReportSettings_' . date('YmdHis');
    }

    private function buildReportSettingActionButtons(ReportSetting $record): string
    {
        $editUrl   = route('panel.setting.report-settings.edit', $record);
        $deleteUrl = route('panel.setting.report-settings.destroy', $record);
