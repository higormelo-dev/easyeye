<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-layout="mini" data-sidebar="sidebar6" data-topbar="bg-light" data-color="info">
<head>
    <meta charset="utf-8">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('panel.dashboard') }}" class="logo">
                        <span class="logo-light">
                            <span class="logo-lg"><img src="{{ asset('system/images/preclinic/logo.svg') }}" alt="{{ config('app.name') }}"></span>
                            <span class="logo-sm"><img src="{{ asset('system/images/preclinic/logo-small.svg') }}" alt="{{ config('app.name') }}"></span>
                        </span>
                        <span class="logo-dark">
                            <span class="logo-lg"><img src="{{ asset('system/images/preclinic/logo-white.svg') }}" alt="{{ config('app.name') }}"></span>
                        </span>
                    </a>
            ...
            <div class="sidebar-logo">
                <div>
                    <a href="{{ route('panel.dashboard') }}" class="logo logo-normal">
                        <img src="{{ asset('system/images/preclinic/logo.svg') }}" alt="{{ config('app.name') }}">
                    </a>
                    <a href="{{ route('panel.dashboard') }}" class="logo-small">
                        <img src="{{ asset('system/images/preclinic/logo-small.svg') }}" alt="{{ config('app.name') }}">
                    </a>
                    <a href="{{ route('panel.dashboard') }}" class="dark-logo">
                        <img src="{{ asset('system/images/preclinic/logo-white.svg') }}" alt="{{ config('app.name') }}">
                    </a>
                </div>
