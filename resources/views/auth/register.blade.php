...
@section('auth_page_title', __('auth.sign_up'))
@section('auth_page_subtitle', __('auth.register.title'))
@section('auth_hero_title', __('auth.register.title'))
@section('auth_hero_text', __('Crie sua conta e comece a usar o EasyEye com seu time.'))
@section('auth_hero_image', asset('system/images/auth/reg-illustration-img.png'))
...
<style>
    ...
    .step-indicator .step-item.done .step-num {
        border-color: #55ce63;
        background: #55ce63;
        color: #fff;
    }
    ...
    .plan-card {
        ...
        text-align: center;
        box-shadow: 0 0 0 3px rgba(0, 158, 251, .12);
    }
    ...
    .plan-card .plan-features li .feat-val {
        font-weight: 600;
        color: #333;
    }
    ...
    <div x-data="registerWizard({{ $plansData }}, {{ $trialDays }})">
        ...
        <div x-show="step === 1"
            ...
            <form @submit.prevent="nextStep">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-text bg-white">
                            <span x-show="emailChecking"><i class="ti ti-loader-2 text-muted ee-icon-spin"></i></span>
                            <span x-show="emailAvailable === true && !emailChecking"><i class="ti ti-circle-check text-success"></i></span>
                            <span x-show="emailAvailable === false && !emailChecking"><i class="ti ti-circle-x text-danger"></i></span>
                            <span x-show="emailAvailable === null && !emailChecking"><i class="ti ti-mail text-muted"></i></span>
                        </span>
                    </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-outline-light" data-toggle-password="#reg-password" tabindex="-1">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="input-group">
                        <input type="password"
                               ...
                               autocomplete="new-password">
                        <button type="button" class="btn btn-outline-light" data-toggle-password="#reg-password-confirmation" tabindex="-1">
                            <i class="ti ti-eye-off"></i>
                        </button>
                    </div>
            ...
            <p class="text-center text-muted mb-0">
                ...
                <a href="{{ route('login') }}" class="hover-a fw-semibold">{{ __('auth.register.log_in') }}</a>
            </p>
        </div>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="form-group mb-4">
                    <label class="form-label">
                        ...
                        <span class="text-muted fw-normal">({{ __('auth.register.optional') }})</span>
                    </label>
                    <input type="text"
                           class="form-control"
                           :class="{ 'is-invalid': errors.company_cnpj }"
                ...
                @if($plans->isNotEmpty())
                    <div class="mb-4">
                        ...
                        <div class="carousel-dots" x-show="plans().length > 1">
                            <template x-for="(plan, index) in plans()" :key="plan.id">
                                <span class="dot" :class="{ active: carouselIndex === index }" @click="goToSlide(index)"></span>
                            </template>
                        </div>
                ...
                <div class="d-flex gap-2 mb-2 mt-3">
                    ...
                    <button type="submit"
                            class="btn btn-info btn-block w-100 waves-effect waves-light"
                            :disabled="loading">
                        <span x-show="!loading">
                            Iniciar <span x-text="trialDays"></span> dias grátis
                            <template x-if="currentPlan">
                                - Plano <span x-text="currentPlan.name"></span>
                            </template>
                        </span>
                        <span x-show="loading"><i class="ti ti-loader-2 me-1 ee-icon-spin"></i> {{ __('auth.register.processing') }}</span>
                    </button>
                </div>
