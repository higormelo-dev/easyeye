<fieldset>
    ...
    <div class="row">
        {{
            html()->div([
                html()->label(__('actions.category'), 'category')->class('form-label'),
                html()->select('category', array_merge(['' => ''], $categories), $record->category ?? null)
                    ->class('form-select')
                    ->attributes([
                        'autocomplete' => 'off'
                    ])
        ...
        {{
            html()->div([
                html()->label(__('actions.name'), 'name')->class('form-label'),
