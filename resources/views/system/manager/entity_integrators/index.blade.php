...
<div x-data="crudForm({
        storeUrl:  '{{ route('panel.manager.entities.integrators.store', $entity->id) }}',
        updateUrl: null,
     ...
     @edit-integrator.window="loadAndEdit(
         '{{ url('panel/manager/entities/' . $entity->id . '/integrators') }}' + '/' + $event.detail.id + '/edit-data',
         '{{ url('panel/manager/entities/' . $entity->id . '/integrators') }}' + '/' + $event.detail.id,
         'integratorModal'
     )">
...
@section('javascript')
    ...
    <script>
    $(function () {
        const entityBaseUrl = '{{ url('panel/manager/entities/' . $entity->id . '/integrators') }}';
