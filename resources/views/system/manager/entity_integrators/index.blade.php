    ...
    <script>
        $(function () {
            ...
            let dataTable = $('#record_datatable').DataTable({
                ...
                "ajax": {
                    'url': `{{ route('panel.ajax.datatables.integrators') }}`,
                    'dataType': 'json',
                    'type': 'POST',
                    'data': {
            ...
            dataTable.on('draw', function () {
                $('.btn-edit').click(function () {
                    ...
                    $('.modal-title-default').append('Editar integrador');
                    $('#btn-modal-default').css('display', 'block');
                    $('.modal-dialog').removeClass('modal-md');
                    $('.modal-dialog').removeClass('modal-lg');
                    $('.modal-dialog').addClass('modal-lg');
                    $.ajax({
                        url: `{{ route('panel.manager.entities.integrators.index', $entity->id) }}/${integrator_id}/edit`,
                        type: 'get',
                        headers: {
                ...
                $('.btn-show').click(function () {
                    integrator_id = $(this).data('id');
                    $('.modal-title-default').empty();
                    $('.modal-title-default').append('Visualizar integrador');
                    $('#btn-modal-default').css('display', 'none');
                    $('.modal-dialog').removeClass('modal-md');
                    $('.modal-dialog').removeClass('modal-lg');
                    $('.modal-dialog').addClass('modal-lg');
                    $.ajax({
                        url: `{{ route('panel.manager.entities.integrators.index', $entity->id) }}/${integrator_id}`,
            ...
            $('.novo-cadastro').click(function () {
                ...
                $.ajax({
                    url: `{{ route('panel.manager.entities.integrators.create', $entity->id) }}`,
                    type: 'get',
                    beforeSend: function () {
            ...
            $('#btn-modal-default').click(function () {
                ...
                let requestURL = (btn_action === 'store') ?
                    `{{ route('panel.manager.entities.integrators.store', $entity->id) }}` :
                    `{{ route('panel.manager.entities.integrators.index', $entity->id) }}/${integrator_id}`;
