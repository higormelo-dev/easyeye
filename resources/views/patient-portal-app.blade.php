...
<head>
    ...
    {{-- LGPD: portal do paciente expõe nome/e-mail/vínculo com clínicas —
         não deve ser indexado por buscadores nem cacheado por crawlers de
         redes sociais (link de convite/reset de senha não pode vazar). --}}
