...
$(function () {
    ...
    let coverTestTypesDataTable = window.LaravelDataTables['covertesttypes_datatable'];

    // Evento de desenho da tabela - registra os handlers dos botões
    $('#covertesttypes_datatable').on('draw.dt', function () {
        ...
        $('.btn-edit').off('click').on('click', function () {
            ...
            $.ajax({
                url: `covertesttypes/${record_id}/edit`,
                type: 'get',
                headers: {
        ...
        $('.btn-active').off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    coverTestTypesDataTable.ajax.reload();
                },
                error: handleAjaxError
            });
        });
        ...
        $('.btn-restore').on('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        method: "get",
                        url: `covertesttypes/${record_id}/restore`,
                        dataType: 'json',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
