...
$(function () {
    ...
    let additionTypeDataTable = $('#additiontypes_datatable').DataTable({
        "retrieve": true,
        "order": [
            [0, 'desc']
        ],
        ...
        "ajax": {
            'url': '/panel/ajax/datatables/additiontypes',
            'dataType': 'json',
            'type': 'POST',
            'data': {
    ...
    additionTypeDataTable.on('draw', function () {
        // Editar
        $('.btn-edit').click(function () {
            record_id = $(this).data('id');
            btn_action = 'update';
            $('.modal-title-default').empty().append('Cadastrar tipo de adição');
            ...
            $.ajax({
                url: `additiontypes/${record_id}/edit`,
                type: 'get',
                headers: {
        ...
        $('.btn-active').click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    additionTypeDataTable.ajax.reload();
                },
                error: handleAjaxError
            });
        });
        ...
        $('.btn-restore').on('click', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        method: "get",
                        url: `additiontypes/${record_id}/restore`,
                        dataType: 'json',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
